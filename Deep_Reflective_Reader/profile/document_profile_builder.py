    ...
    def _build_profile_classification_prompt(
        ...
        *,
        ...
        return (
            ...
            "Use candidate_lines as clues, but make the classification from overall semantic evidence.\n"
            "If uncertain, use 'unknown'.\n\n"
            "Semantic guidance:\n"
            "- title_uniqueness_risk means risk that chapter or section titles are duplicated or too generic to be safe API targets.\n"
            "- It is not about whether the document/book title is unique; it is about structural node titles inside the document.\n"
            "- Repeated local chapter labels under different parent grouping units indicate high risk.\n"
            "- likely_heading_style means the dominant visible heading convention; decide by semantic pattern instead of memorizing one language.\n"
            "- likely_heading_style options:\n"
            "  chinese_chapter_numbers: Chinese ordinal chapter numbering convention.\n"
            "  english_chapter_words: English-like chapter labels with number words or numerals.\n"
            "  roman_numeral_parts: part/book/volume-like headings using roman numerals.\n"
            "  numbered_decimal_sections: decimal numbering style such as 1.1 / 2.3.\n"
            "  numbered_chinese_points: Chinese ordinal point/list convention.\n"
            "  plain_title_headings: semantic title headings without stable numbering convention.\n"
            "  none/mixed/unknown: use when appropriate by evidence quality.\n"
            "- document_structure_shape options:\n"
            "  chapter_only: mainly a sequence of peer chapter-like units.\n"
            "  part_chapter: parent grouping units with repeated/local chapters under them.\n"
            "  chapter_section: chapters with meaningful lower-level sections.\n"
            "  essay_sections: essay/article organized by conceptual sections.\n"
            "  flat_long_text / over_fragmented / mixed / unknown: choose conservatively when evidence is weak.\n\n"
            "Return schema:\n"
            "{\n"
            '  "topic": string,\n'
            '  "summary": string,\n'
